...
def getCIFAR10Dataloaders(config):
  ...
  train_loader = DataLoader(train_set, shuffle=True, batch_size=config["bs"], num_workers=0, pin_memory=True)
  val_loader = DataLoader(val_set, shuffle=False, batch_size=5*config["bs"], num_workers=0, pin_memory=True)
